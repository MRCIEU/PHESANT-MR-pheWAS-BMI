...
shareddir=paste(ukbdatadir,'/_latest/UKBIOBANK_Array_Genotypes_500k_HRC_Imputation/data/raw_downloaded/',sep="")
outdir=paste(dataDir,'/qc/',sep='')
...
##
# our genetic ids
idfile = paste(shareddir,'8786_link/con/ukb878_con_chr10_v2_s488374.fam',sep="")
...
file = paste(shareddir, 'ukb_sqc_v2.txt', sep="")
...
relFile = paste(shareddir, '8786_link/ukb878_rel_s488374.dat', sep="")
