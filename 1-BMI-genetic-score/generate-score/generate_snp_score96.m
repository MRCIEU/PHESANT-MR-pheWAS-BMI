...
%+ data.rs2033529 	* 0.019 NOT IN UK BIOBANK DATA
...
snpscore96 = snpscore96 + data.rs1558902 	* 0.082;
...
dlmwrite(strcat(dir,'snp-score96.txt'), [double(data(:,1)) snpscore96], 'precision', 16);
