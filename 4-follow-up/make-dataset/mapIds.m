...
snpscore = dataset('file',strcat(dataDir, 'snps/nervousness-snps97.txt'),'delimiter',',');
...
export(combined,'file', strcat(dataDir, 'snps/nervousness-snps97-withPhenIds.csv'), 'delimiter',',');
